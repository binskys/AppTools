package com.project.tools.titlebar;
...
import com.project.tools.basic.AppUtils;
...
public class StatusBarUtils {
     ...
     * 设置View稿度（动态改变）
     */
    public void setSystemStatusBar(View statusBar) {
        if (AppUtils.getSystemVersion() < Build.VERSION_CODES.KITKAT) {
            ...
            statusBar.setLayoutParams(linearParams);
