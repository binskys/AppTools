...
public class AppUtils {
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = ToolManager.getInstance().getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
    ...
    public static String getDeviceId() {
        TelephonyManager telephonyManager = (TelephonyManager)ToolManager.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getClassName() {
        ActivityManager manager = (ActivityManager)ToolManager.getInstance().getSystemService(Context.ACTIVITY_SERVICE);
