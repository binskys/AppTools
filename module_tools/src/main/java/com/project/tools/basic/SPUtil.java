...
public class SPUtil {
    ...
    //保存文件名
    public static final String FILE_NAME = "honeycomb_data";
    /**
     * 保存数据（默认异步保存数据）
     *  @param key
     * @param object
    ...
    public static String put(String key, Object object) {
        if (CommonUtil.isEmpty(object.toString())) {
            LogUtils.e(key+" 为空");
        }
        //打开Preferences，名称为FILE_NAME，如果存在则打开它，否则创建新的Preferences
        SharedPreferences sp = ToolManager.getInstance().getSharedPreferences(FILE_NAME,
