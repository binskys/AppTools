...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) ToolManager.getInstance().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusHeight() {
        ...
        try {
            ...
            statusHeight = ToolManager.getInstance().getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return statusHeight;
